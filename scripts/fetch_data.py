...
def main():
    ...
    parser.add_argument('-f','--function', default='TIME_SERIES_DAILY')
    parser.add_argument('-i','--interval', default='60min')
    parser.add_argument('-o','--outputsize', default='full')
    parser.add_argument('-d','--datadir', default='data/raw')
